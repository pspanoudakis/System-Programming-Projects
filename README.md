...
When file processing is over, the app will inform the user.
...
- In each Country structure, 5 population counters are stored:
    ...
    Than practically means that a Citizen without YES/NO record regarding a specific Virus, 
...
Successfully tested in DIT Ubuntu 16.04 as well.
